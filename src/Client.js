...
/**
 * Cheesus Christ's custom client
...
class Client extends Discord.Client {
  ...
  constructor(config, options = {}) {
    ...
    /** 
     * Cheesus Christ's owner ID
     * @type {string}
     */
    this.ownerId = config.ownerId;

    /** 
     * Cheesus Christ's bug report channel ID
     * @type {string}
     */
    this.bugReportChannelId = config.bugReportChannelId;

    /** 
     * Cheesus Christ's feedback channel ID
     * @type {string}
     */
    this.feedbackChannelId = config.feedbackChannelId;

    /** 
     * Cheesus Christ's server log channel ID
     * @type {string}
     */
