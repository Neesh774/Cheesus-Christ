...
module.exports = class BotInfoCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: ['bot', 'bi'],
      usage: 'botinfo',
      description: 'Fetches Cheesus Christ\'s bot information.',
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('Cheesus Christ\'s Bot Information')
      .setDescription(oneLine`
        Cheesus Christ is an open source, fully customizable Discord bot that is constantly growing.
